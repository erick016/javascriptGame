...
function playGame()
{
	...
	if (hitTestCircle(rocketObj,burgerObj))
	{
		...
		/*burgerObj.earthXComponent = (burgerObj.x+burgerObj.width/2) - (earthObj.x+earthObj.width/2); 
		burgerObj.earthYComponent = (burgerObj.y+burgerObj.height/2) - (earthObj.y+earthObj.height/2);
		burgerObj.earthDistance = Math.sqrt((burgerObj.earthXComponent*burgerObj.earthXComponent + burgerObj.earthYComponent*burgerObj.earthYComponent)); 
		
		burgerObj.marsXComponent = (burgerObj.x+burgerObj.width/2) - (marsObj.x+marsObj.width/2); 
		burgerObj.marsYComponent = (burgerObj.y+burgerObj.height/2) - (marsObj.y+marsObj.height/2);
		burgerObj.marsDistance = Math.sqrt((burgerObj.marsXComponent*burgerObj.marsXComponent + burgerObj.marsYComponent*burgerObj.marsYComponent));*/ 
		
		//while((hitTestCircle(marsObj,burgerObj))||(hitTestCircle(earthObj,burgerObj))||(burgerObj.x < 100) || (burgerObj.marsDistance < 40))
